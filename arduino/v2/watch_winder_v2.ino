// cloned https://github.com/fuganater/OpenWinder.git

// Configuration
#define CYCLES 5
#define ROT_R 3  //default 2
#define ROT_L 3  //default 2
...
/* used for logging/serial output only */
...
void loop()
{
  ...
  if (WState != old_state)
  {
    ...
    Serial.print(String(old_state) + "-" + String(WState)+ ", ");
    Serial.print(stateTypeName[old_state]);
    Serial.print(" -> ");
    Serial.println(stateTypeName[WState]);
  }
